  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-lg border border-neutral-800 bg-neutral-900 shadow-2xl">
        {/* Title Bar */}
        <div className="flex items-center justify-between gap-2 bg-neutral-800 px-5 py-3">
          {/* Mac-style dots */}
          ...
          <button
            ...
            className="flex h-5 w-full items-center justify-end text-neutral-400 transition-colors hover:text-white"
          >
            <CircleX />
          </button>
        </div>
